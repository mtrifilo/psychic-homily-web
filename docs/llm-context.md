...
| Frontend      | Sidebar nav, Cmd+K command palette, redesigned show/artist/venue cards, density toggle, EntityDetailLayout template, festival listing + detail pages with tiered lineup. **Feature modules** (`features/`): co-located components/hooks/types for releases, labels, festivals, blog, auth, collections; shows/artists/venues in review.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
- **Phase 2a (NOW, parallel):** Community foundations — ~~PSY-63~~ ~~PSY-64~~ ~~PSY-65~~ ~~PSY-66~~ DONE, PSY-67–68 (collection UI), PSY-70–72 requests, PSY-73/74 revision history.
- **Code reorg (nearly complete):** Backend services reorg PSY-84–92 ALL DONE. Frontend feature modules PSY-93–103 DONE. Remaining: PSY-96 (shows), PSY-97 (artists), PSY-98 (venues) in review.
