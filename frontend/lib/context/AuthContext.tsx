...
export function AuthProvider({ children }: AuthProviderProps) {
    ...
    const [userOverride, setUserOverride] = useState<User | null | undefined>(undefined)
    ...
    const value: AuthContextType = useMemo(() => ({
        ...
        clearError,
        logout,
    }), [user, isLoading, logoutMutation.isPending, error, setUser, setError, clearError, logout])
