  ...
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-10">
      <header className="mb-8">
        <h1 className="font-display text-2xl font-bold text-foreground">Hero spotlight — fix comparison</h1>
        <p className="mt-1 max-w-[760px] text-sm text-muted-foreground">
          Three fixes for the hard rectangular cutoff of the cursor glow, all at the chosen Variant 1 density.
          Switch to <strong>dark mode</strong> (nav toggle) and hover each near its edges to compare.
        </p>
      </header>
