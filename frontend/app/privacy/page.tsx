...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://psychichomily.com/privacy',
  },
}
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/90">
              ...
              <li><strong>Approximate Location:</strong> When you browse pages with an upcoming-shows city filter (such as the home page, the Shows listing, and the Explore page), or the knowledge-graph page, the hosting platform (Vercel) infers an approximate, city-level location from your IP address. I use this only to pre-select a nearby city in those filters and to point the graph page&apos;s scene shortcuts at your own city, both of which you can change or ignore at any time. This inferred city is read transiently on each request, is not precise, is not stored against your account or any identifier, and is not used to build a profile or track you. See Section 3.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/90">
              ...
              <li><strong>Personalization:</strong> To remember your preferences such as theme, timezone, and language, and to use the approximate, city-level location inferred from your IP address to pre-select a nearby city in the upcoming-shows filters (on the home page, the Shows listing, and the Explore page) and to point the knowledge-graph page&apos;s scene shortcuts at your own city (overridable defaults and ordinary links only — see Section 2.3).</li>
