...
export function SceneGraph({ slug, city, state }: SceneGraphProps) {
  ...
  const clusterCaption =
    clusterBy === 'community'
      ...
      : 'Clusters group artists by their most-frequent venue.'
  ...
  // PSY-1296: a capped graph must say so — "12 artists" on a 90-band metro
  // reads as the whole scene. Shared phrase (sceneGraphCopy) so this header
