  ...
  return (
    <div className="mb-6">
      ...
      {/* PSY-1260: discovery-bias slider — interpolates DOI's importance weight from Popular
          ...
          the labels + suggested directions live. Native range input so it's keyboard- and
          screen-reader-accessible; the canvas repaint rides the suggestedIds change (already in
          ArtistGraph's resumeAnimation deps for this re-rank-without-graphData-change case). */}
      <div className="flex items-center gap-2 mb-3 text-xs text-muted-foreground">
        ...
        <input
          ...
          aria-label="Discovery bias, from popular to niche"
          aria-valuetext={
            diversityBias === 0
              ? 'Popular'
              : diversityBias === 1
