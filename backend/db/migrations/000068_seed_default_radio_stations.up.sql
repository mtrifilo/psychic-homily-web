...
VALUES
    ...
    ((SELECT id FROM radio_stations WHERE slug = 'kexp'), 'The Afternoon Show', 'the-afternoon-show', 'Larry Mizell, Jr.', 'KEXP afternoon programming with a mix of established and emerging artists.', 'Weekdays 2-6 PM PT', 'https://www.kexp.org/shows/the-afternoon-show/', '14', TRUE),
