...
echo "4. Test the deployment: curl https://stage.api.psychichomily.com/health/ready"
echo "   (/health is liveness only — it returns 200 even with the database down,"
echo "    which proves nothing after a migration. /health/ready 503s instead.)"
