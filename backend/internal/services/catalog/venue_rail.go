...
// venue-local night in progress. The two sets therefore differ at both edges by
// up to a night, and this one drops a show that is already under way while the
// scene list still holds it.
//
