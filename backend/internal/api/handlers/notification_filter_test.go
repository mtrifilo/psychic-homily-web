...
type mockNotificationFilterService struct {
	createFilterFn         func(userID uint, input contracts.CreateFilterInput) (*models.NotificationFilter, error)
	updateFilterFn         func(userID uint, filterID uint, input contracts.UpdateFilterInput) (*models.NotificationFilter, error)
	deleteFilterFn         func(userID, filterID uint) error
	getUserFiltersFn       func(userID uint) ([]models.NotificationFilter, error)
	getFilterFn            func(userID, filterID uint) (*models.NotificationFilter, error)
	quickCreateFilterFn    func(userID uint, entityType string, entityID uint) (*models.NotificationFilter, error)
	matchAndNotifyFn       func(show *models.Show) error
	matchAndNotifyBatchFn  func(shows []models.Show) error
	getUserNotificationsFn func(userID uint, limit, offset int) ([]contracts.NotificationLogEntry, error)
	getUnreadCountFn       func(userID uint) (int64, error)
	pauseFilterFn          func(filterID uint) error
}
...
func (m *mockNotificationFilterService) DeleteFilter(userID, filterID uint) error {
...
func (m *mockNotificationFilterService) GetFilter(userID, filterID uint) (*models.NotificationFilter, error) {
...
func (m *mockNotificationFilterService) GetUserNotifications(userID uint, limit, offset int) ([]contracts.NotificationLogEntry, error) {
